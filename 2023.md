...
* [Automate testing with Page object model using ***Robot Framework***](https://github.com/kendosarun/automate-test-script/blob/main/robotframework/test/saucedemo.robot) 🔑 Private Repo

* [Automate testing with Page object model using ***Cypress.io***](https://github.com/kendosarun/automate-test-script/blob/main/cypress/cypress/e2e/saucedemo.cy.ts) 🔑 Private Repo

* [Basic automate testing using ***Playwright***](https://github.com/kendosarun/automate-test-script/blob/main/playwright/tests/saucedemo.spec.ts) 🔑 Private Repo
